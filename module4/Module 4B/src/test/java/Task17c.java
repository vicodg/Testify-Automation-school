...
public class Task17c {
    ...
    public void widgetsPage() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//body/div[@id='app']/div[1]/div[1]/div[2]/div[1]/div[4]/div[1]/div[3]")).click();
        Thread.sleep(2000);

        SoftAssert softAssert = new SoftAssert();
        softAssert.assertTrue(driver.getCurrentUrl().contains("widgets"));
